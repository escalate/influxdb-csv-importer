...
class TestClass(object):
    ...
    @pytest.mark.parametrize("fmt", ["epoch", "datetime"])
    ...
    @pytest.mark.parametrize("tz", ["UTC", "Europe/Berlin", "US/Eastern"])
    ...
    @pytest.mark.parametrize("lc", ["de_DE.UTF-8", "en_GB.UTF-8"])
